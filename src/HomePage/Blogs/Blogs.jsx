...
const Blogs = () => {
  const data = "This is the pdf content";
    ...
    <div>
          ...
          {({ blob, url, loading, error }) =>
            loading ? (
              ...
              <div className="text-end">
                <button className="btn-primary p-2 rounded-xl text-xl ">
                  Download blog pdf
                </button>
              </div>
            )
      ...
      <div className="container mx-auto p-5 ">
        ...
        <div className="overflow-x-auto mt-4">
          <table className="table w-full">
            ...
            <tbody>
              <tr>
                <td>
                  The form data is managed by React and stored in the
                  component's state.
                </td>
                <td>
                  The form data is managed by the DOM and read using a ref.
                </td>
              </tr>
              <tr>
                <td>
                ...
                <td>
                  The value of the input is set by the user and read using a
                  ref.
                </td>
              </tr>
              <tr>
                <td>
                  Controlled components provide a single source of truth for
                  form data, making it easier to manage and validate.
                </td>
                <td>
                  Uncontrolled components provide less control over the form
                  data, but can be useful in some cases where you don't need to
                  track the state of the input field.
                </td>
              </tr>
              <tr>
                <td>
                  Controlled components can be more verbose and require more
                  code to manage the state.
                </td>
                <td>
        ...
        <p className="text-2xl text-white mt-8">
          <span className="border rounded-full p-1 bg-orange-400">2</span> How
        ...
        <div className="text-white">
          ...
          <li>
            Import PropTypes at the top of your component: 'import PropTypes
            from 'prop-types';'
          </li>
        ...
        <div className="text-white">
          ...
          <li>
            ...
            building web applications and APIs, including routing, middleware,
            and template engines.
          </li>
          <li>
            Node.js has a low-level API, while Express.js provides a
            higher-level API that is easier to work with.
          </li>

          <li>
            Node.js can be used to build a wide range of server-side
            applications, while Express.js is primarily used for building web
        ...
        <p className="text-2xl text-white mt-8">
          <span className="border rounded-full p-1 bg-orange-400">4</span> What
