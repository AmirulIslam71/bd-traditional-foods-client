      ...
      <div className="container mx-auto grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
        <div className="card w-full shadow-2xl">
          ...
          <div className="card-body text-center text-white">
            ...
            <p>
              A clean kitchen promotes a healthy home. Regular cleaning and
              proper storage of food waste are important for food quality and
              safety.
            </p>
          </div>
        </div>
        <div className="card w-full shadow-2xl">
          <div className="card-body text-center text-white">
            ...
            <p>
              Skilled chefs possess extensive knowledge and experience in
              culinary arts, creating delicious and visually appealing dishes.
            </p>
          </div>
          <figure>
            <img
        ...
        <div className="card w-full shadow-2xl">
          ...
          <div className="card-body text-center text-white">
            ...
            <p>
              Feeling healthy involves physical, mental, and emotional
              well-being. It is achieved through regular exercise, a balanced
              diet, and self-care practices.
            </p>
          </div>
        </div>
        <div className="card w-full shadow-2xl">
